# Mastodon Online Trademarks Logo 1200x630 | (Holloway) Chew, Kean Ho's Visuals
...
`avif`, etc). Hence, a re-draw is required.

This project derives Mastodon Online Trademarks Logo specifically for 1200x630
size.
...
Please read through Mastodon's Trademark Engineering Specification
(https://joinmastodon.org/branding) before editing to avoid any unwanted legal
implications.

While not specified by Mastodon, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: Mastodon Online Trademarks Logo 1200x630
...
> **YOU ARE STILL OBLIGATED TO COMPLY WITH MASTODON TRADEMARK REQUIREMENTS
> (Read: https://joinmastodon.org/branding)**.
>
